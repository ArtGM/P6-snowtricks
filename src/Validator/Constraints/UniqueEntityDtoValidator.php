...
class UniqueEntityDtoValidator extends ConstraintValidator {
	...
	public function validate( $object, Constraint $constraint ) {
		...
		$this->context->buildViolation( $this->constraint->message )
		              ...
		              ->setCode( UniqueEntityDto::NOT_UNIQUE_ERROR )
		              ->setCause( $result )
		              ->addViolation();
	}
	...
	private function checkTypes() {
		...
		if ( ! $this->constraint instanceof UniqueEntityDto ) {
			throw new UnexpectedTypeException( $this->constraint, UniqueEntityDto::class );
		}
