...
// webpack.config.components file.
...
Encore
  ...
  // will require an extra script tag for runtime.components
  ...
  .enableVersioning(Encore.isProduction()).configureBabel(
...
//.enableReactPreset()
//.addEntry('admin', './assets/admin.components')
